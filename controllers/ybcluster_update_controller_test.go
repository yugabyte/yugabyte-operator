...
func TestUpdateMasterHeadlessService(t *testing.T) {
	...
	newCluster := &yugabytecomv1alpha1.YBCluster{
		Spec: *getMinimalClusterSpec(),
	}
...
func TestUpdateMasterStatefulset(t *testing.T) {
	...
	newCluster.Spec.Master.Gflags = []yugabytecomv1alpha1.YBGFlagSpec{
		{
			Key:   "key1",
			Value: "value1",
		},
...
func TestUpdateTServerStatefulset(t *testing.T) {
	...
	newCluster.Spec.Tserver.Gflags = []yugabytecomv1alpha1.YBGFlagSpec{
		{
			Key:   "key1",
			Value: "value1",
		},
