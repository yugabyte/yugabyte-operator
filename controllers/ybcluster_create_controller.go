...
func createMasterSecret(cluster *yugabytecomv1alpha1.YBCluster) (*corev1.Secret, error) {
	return createSecret(cluster, false)
}

func createTServerSecret(cluster *yugabytecomv1alpha1.YBCluster) (*corev1.Secret, error) {
	return createSecret(cluster, true)
}

func createSecret(cluster *yugabytecomv1alpha1.YBCluster, isTServerService bool) (*corev1.Secret, error) {
...
func getSecretData(cluster *yugabytecomv1alpha1.YBCluster, isTServerService bool) (*map[string][]byte, error) {
...
func createMasterHeadlessService(cluster *yugabytecomv1alpha1.YBCluster) (*corev1.Service, error) {
	return createHeadlessService(cluster, false)
}

func createTServerHeadlessService(cluster *yugabytecomv1alpha1.YBCluster) (*corev1.Service, error) {
	return createHeadlessService(cluster, true)
}

func createHeadlessService(cluster *yugabytecomv1alpha1.YBCluster, isTServerService bool) (*corev1.Service, error) {
...
func createMasterUIService(cluster *yugabytecomv1alpha1.YBCluster) (*corev1.Service, error) {
...
func createTServerUIService(cluster *yugabytecomv1alpha1.YBCluster) (*corev1.Service, error) {
...
func createUIService(cluster *yugabytecomv1alpha1.YBCluster, isTServerService bool) (*corev1.Service, error) {
...
func createMasterStatefulset(cluster *yugabytecomv1alpha1.YBCluster) (*appsv1.StatefulSet, error) {
	return createStatefulSet(cluster, false)
}

func createTServerStatefulset(cluster *yugabytecomv1alpha1.YBCluster) (*appsv1.StatefulSet, error) {
	return createStatefulSet(cluster, true)
}

func createStatefulSet(cluster *yugabytecomv1alpha1.YBCluster, isTServerStatefulset bool) (*appsv1.StatefulSet, error) {
	replicas := cluster.Spec.Master.Replicas
	name := masterName
	label := masterName
	serviceName := masterNamePlural
...
func getVolumeClaimTemplates(storageSpec *yugabytecomv1alpha1.YBStorageSpec) *[]corev1.PersistentVolumeClaim {
...
func createPodSpec(cluster *yugabytecomv1alpha1.YBCluster, isTServerStatefulset bool, name, serviceName string) corev1.PodSpec {
...
func createContainer(cluster *yugabytecomv1alpha1.YBCluster, isTServerStatefulset bool, name, serviceName string) corev1.Container {
...
func getVolumeMounts(storageSpec *yugabytecomv1alpha1.YBStorageSpec, tlsEnabled, isTServer bool) []corev1.VolumeMount {
